...
export default function IntroScreen({ navigation }) {
    ...
    const [sliders, ,] = useState([
        {
            image: require('../assets/images/on-boarding/step_1.png'),
        },
        {
            image: require('../assets/images/on-boarding/step_2.png'),
        },
        {
            image: require('../assets/images/on-boarding/step_3.png'),
        },
    ]);
