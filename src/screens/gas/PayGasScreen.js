...
import CustomCheckbox, { CustomCheckTickbox, CustomCheckTickbox2 } from '../../components/CustomCheckbox'
import { AddATMCardComponent, AddUPICardComponent, PayCardComponent } from '../DTH/PayDTHScreen'

export default function PayGasScreen({ navigation }) {
    return (
        <>
            {custom_header("Pay for Cylinder Booking", navigation)}
                ...
                <View style={{ margin: 16 }}>
                    <View style={commonStyles.customCard}>
                        ...
                        <View style={[commonStyles.row, { marginTop: 5 }]}>
                            <Text style={{ ...commonStyles.fs10_400, color: "#85949F" }}>Bill Details: </Text>
                            <Text style={{ ...commonStyles.fs10_400, color: COLORS.pink }}>HIDE</Text>
                        </View>

                        <View style={[commonStyles.row, { marginTop: 5 }]}>
                            <Text style={{ ...commonStyles.fs10_400, color: "#85949F" }}>Order Number: </Text>
                            <Text style={{ ...commonStyles.fs10_400, color: COLORS.pink }}>NA</Text>
                        </View>

                        <View style={[commonStyles.row, { marginTop: 5 }]}>
                            <Text style={{ ...commonStyles.fs10_400, color: "#85949F" }}>Customer Name: </Text>
                            <Text style={{ ...commonStyles.fs10_400, color: COLORS.pink }}>Arlene McCoy</Text>
                        </View>

                        <View style={[commonStyles.row, { marginTop: 5 }]}>
                            <Text style={{ ...commonStyles.fs10_400, color: "#85949F" }}>Cunsumer Number: </Text>
                            <Text style={{ ...commonStyles.fs10_400, color: COLORS.pink }}>P03456</Text>
                        </View>

                        <View style={[commonStyles.row, { marginTop: 5, marginBottom: 15 }]}>
                            <Text style={{ ...commonStyles.fs10_400, color: "#85949F" }}>Order Date: </Text>
                            <Text style={{ ...commonStyles.fs10_400, color: COLORS.pink }}>NA</Text>
                        </View>

                        <View style={{ width: "100%", padding: 14, backgroundColor: "#F6F6F6", borderRadius: 9 }}>
                            <Text style={{ fontSize: 23, fontWeight: "500", color: "#000" }}>₹ 241</Text>
                        </View>
                    </View>
